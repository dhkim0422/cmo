        ...
        data() {
            return {
                menuList: [
                    ...
                    {path: "/analysis/analysis", rootMenuNm: "ANALYSIS", menuNm: "ANALYSIS",},
                    {path: "/blast/blastSearch", rootMenuNm: "내정보", menuNm: "내정보"},
                    {path: "/project/projectList", rootMenuNm: "과제", menuNm: "과제"},
                    {path: "/targets/targetList", rootMenuNm: "연구대상자", menuNm: "연구대상자"},
                    {path: "/samples/samplesList", rootMenuNm: "샘플", menuNm: "샘플"},
                    {path: "/omics/omics", rootMenuNm: "마이페이지", menuNm: "오믹스 데이터 등록내역"},
                ],
                rootMenuNm: "",
                menuNm: "",
            };
