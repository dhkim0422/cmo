                ...
                <div class="modal-body">
                    ...
                    <table class="view-table">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="form-control" type="text" title="단위사업"
                                       name="unitProgram"
                                       placeholder="작성하여주세요"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" title="중분야"
                                       name="middleRealm"
                                       placeholder="작성하여주세요" v-model="model.middleRealm"
                                />
                        ...
                        <tr>
                            ...
                            <td>
                                <div layout="row" style="height:55px">
                                    <b-form-datepicker v-model="model.begin" id="datepicker-begin" size="sm" local="ko" class="mb-2"></b-form-datepicker>
                                    <b-form-datepicker v-model="model.end" id="datepicker-end" size="sm" local="ko" class="mb-2"></b-form-datepicker>
                                </div>
                            </td>
                        </tr>
                        <tr>
