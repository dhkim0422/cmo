    ...
    <div class="container" id="content">
        <form>
            ...
            <div class="filter-group" style="margin-bottom: 0px;">
                ...
                <div class="group-item">
                    <span data-toggle="tooltip" data-placement="top" title=" 연구과제_삭제 ">
                    ...
                    <span data-toggle="tooltip" data-placement="top" title=" 연구과제_수정 ">
                    <button class="btn-primary-sm" type="button" ng-click="onClickChangeLink()">
            ...
            <table class="view-table">
                <caption class="sr-only"> basicinfo </caption>
                <tbody>
                <tr>
    ...
    export default {
        ...
        methods: {
            async initData(id) {
                ...
                let summayrData = await axios.get('/isg-oreo/statistics/summary/projects/' + id, {});
