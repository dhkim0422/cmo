<template>
  <div class="container" id="content">
    <page-head-info :menu-nm="model.program" :root-menu-nm="model.accession"/>
    <form>
      <!-- 요약 -->
      ...
      <table class="view-table">
        ...
        <tr>
          <th scope="row">대분야</th>
          <td>{{ model.unitProgram | projectType }}</td>

          <th scope="row">중분야</th>
          <td>{{ model.middleRealm | projectType }}</td>
...
export default {
  name: "ProjectsDetail",
  components: {PageHeadInfo, ProjectMerge},
  data() {
    return {
      model: {
        projectStatus: {},
