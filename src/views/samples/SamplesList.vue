        ...
        <table class="data-table">
            ...
            <tr>
                <th class="custom-checkbox">
                    <input type="checkbox" id="chkSampleAll" class="custom-control-input"/>
                    <label class="custom-control-label" for="chkSampleAll"><span class="sr-only">선택</span></label>
                </th>
                <th>등록번호</th>
                <th>연구대상자_등록번호</th>
                <th>성별</th>
    ...
    export default {
        ...
        data() {
            return {
                ...
                filters: {//해당 내역을 서치박스의 셀렉트 리스트가 생성됩니다.
                    fields: [
                        {id: '', name: '전체'},
